...
/-- **The Euler chain.** If at `(a, z)` saving is lower and consumption strictly higher at the
higher rate, the four Euler inequalities and the elasticity condition at tomorrow's assets
