...
The table is computed at $r\approx4\%$, where Aiyagari's equilibria at $\mu=1$ and most at
$\mu\in\{3,5\}$ sit. His Table II also has equilibria at much lower rates, down to $-0.35\%$ at
$\mu=5$, $\sigma=0.4$, $\rho=0.9$, where $\kappa$ is far smaller ($0.005$); the identity
$\text{right}-\text{left}=1/(\kappa R)$ holds at any rate, so the tail margin there is larger,
about $190$.
