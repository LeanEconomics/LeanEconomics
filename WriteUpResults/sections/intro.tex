...
in a general mean-field framework; \citet{YoungWalsh2025} showed by computation that at high risk
aversion the supply curve can bend backward and the equilibrium can fail to be unique. The survey
...
Continuous-time counterparts are in \citet{AchdouEtAl2022}. The formalisation uses the fixed-point
